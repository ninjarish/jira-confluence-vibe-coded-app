...
export class JiraService {
  ...
  public static async UpdateIssue_V2(X_Request_Jirainstance: string, issueKey: string, body: UpdateIssueRequest): Promise<IOperationResult<string>> {
    const params: { "X-Request-Jirainstance": string, issueKey: string, body: UpdateIssueRequest } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueKey, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueKey: string, body: UpdateIssueRequest }, string>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListIssueTypes_V2(X_Request_Jirainstance: string, projectKey: string): Promise<IOperationResult<IssueTypes>> {
    ...
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectKey: string }, IssueTypes>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListIssueTypesFields_V2(X_Request_Jirainstance: string, projectKey: string, issuetypeIds: string): Promise<IOperationResult<IssueTypes>> {
    const params: { "X-Request-Jirainstance": string, projectKey: string, issuetypeIds: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectKey, issuetypeIds };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectKey: string, issuetypeIds: string }, IssueTypes>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListStatuses_V2(X_Request_Jirainstance: string, projectId: string, issueType?: string): Promise<IOperationResult<StatusList>> {
    const params: { "X-Request-Jirainstance": string, projectId: string, issueType?: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectId, issueType };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectId: string, issueType?: string }, StatusList>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListPriorityTypes_V2(X_Request_Jirainstance: string): Promise<IOperationResult<PriorityList>> {
    const params: { "X-Request-Jirainstance": string } = { "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string }, PriorityList>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListIssues(X_Request_Jirainstance: string, jql?: string, expand?: string, fields?: string): Promise<IOperationResult<ListIssuesResponse>> {
    const params: { "X-Request-Jirainstance": string, jql?: string, expand?: string, fields?: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, jql, expand, fields };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, jql?: string, expand?: string, fields?: string }, ListIssuesResponse>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
